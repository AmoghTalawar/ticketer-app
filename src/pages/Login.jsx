    ...
    <div style={{ 
      ...
      <main style={{ 
        ...
        <div style={{ 
          ...
          <h1 style={{ fontSize: '2.25rem', fontWeight: '800', marginBottom: '0.5rem', background: 'linear-gradient(135deg, #fff 0%, #888 100%)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>Log In</h1>
          <p style={{ color: 'rgba(255, 255, 255, 0.6)', marginBottom: '2.5rem', fontSize: '0.95rem' }}>Welcome back! Log in to manage your tickets.</p>
          ...
          >
            <Wallet size={20} /> Connect MetaMask Wallet
          </button>
          ...
          <form style={{ textAlign: 'left', display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', fontSize: '0.9rem', marginTop: '0.25rem' }}>
              <label style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', cursor: 'pointer', color: 'rgba(255, 255, 255, 0.7)' }}>
                <input type="checkbox" style={{ accentColor: 'var(--clr-primary-500)' }} />
                <span>Remember me</span>
              </label>
              <a href="#" style={{ color: 'var(--clr-primary-400)', textDecoration: 'none', fontWeight: '600' }}>Forgot password?</a>
            </div>
          ...
          <div style={{ margin: '2rem 0', position: 'relative', textAlign: 'center' }}>
            ...
            <span style={{ position: 'relative', background: '#0a0b10', padding: '0 1rem', color: 'rgba(255,255,255,0.4)', fontSize: '0.85rem', zIndex: 2 }}>Or Social Login</span>
          </div>
          ...
          <p style={{ marginTop: '2.5rem', color: 'rgba(255,255,255,0.6)', fontSize: '0.95rem' }}>
            Don't have an account? <Link to="/register" style={{ color: 'var(--clr-primary-400)', fontWeight: 'bold', textDecoration: 'none' }}>Sign up</Link>
          </p>
        </div>
      </main>
