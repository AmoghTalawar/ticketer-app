    ...
    <div style={{ backgroundColor: '#F8F9FA', minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
      ...
      <main style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '12rem 1rem 6rem 1rem' }}>
        <div style={{ background: '#fff', padding: '3rem', borderRadius: '16px', boxShadow: 'var(--shadow-sm)', width: '100%', maxWidth: '450px', textAlign: 'center' }}>
          <h1 style={{ fontSize: '2rem', fontWeight: 'bold', marginBottom: '0.5rem', color: '#111' }}>Log In</h1>
          <p style={{ color: '#888', marginBottom: '2.5rem' }}>Welcome back! Please enter your details.</p>
          ...
          <form style={{ textAlign: 'left', display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
            ...
            <div>
              ...
              <input type="password" placeholder="••••••••" style={{ width: '100%', padding: '0.75rem 1rem', borderRadius: '8px', border: '1px solid #ddd', outline: 'none' }} />
            </div>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', fontSize: '0.9rem' }}>
              ...
              <a href="#" style={{ color: 'var(--clr-primary-500)', textDecoration: 'none', fontWeight: '500' }}>Forgot password?</a>
            </div>
          ...
          <div style={{ margin: '2rem 0', position: 'relative', textAlign: 'center' }}>
            ...
            <span style={{ position: 'relative', background: '#fff', padding: '0 1rem', color: '#888', fontSize: '0.9rem', zIndex: 2 }}>Or log in with</span>
          </div>
          ...
          <p style={{ marginTop: '2.5rem', color: '#555', fontSize: '0.95rem' }}>
            Don't have an account? <Link to="/register" style={{ color: 'var(--clr-primary-500)', fontWeight: 'bold', textDecoration: 'none' }}>Sign up</Link>
          </p>
        </div>
      </main>
